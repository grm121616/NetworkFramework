#
#  Be sure to run `pod spec lint NetworkFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/grm121616/NetworkFramework/tree/1.0.0"
  ...
  spec.source       = { :git => "https://github.com/grm121616/NetworkFramework.git", :tag => "1.0.0" }
  ...
  spec.source_files  = "NetworkFramework"
